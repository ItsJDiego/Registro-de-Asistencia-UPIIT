...
public class UserRegistration extends javax.swing.JFrame {
    ...
    public UserRegistration() {
        initComponents();
        BDUtility.setImage(this, "images/back.jpg", 850, 600);
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        try {
            ...
            try{
                ...
                if(rs.next()){
                    JOptionPane.showMessageDialog(null,"Correo duplicado.","Duplicado",JOptionPane.WARNING_MESSAGE);
                    return;
                }
            } catch (Exception ex){
                ex.printStackTrace();
            ...
            String insertQuery = "INSERT into userdetails (name,gender, emaiol, contact, address, state, country, uniquequeregid, imagename) VALUES (?,?,?,?,?,?,?,?,?)";
