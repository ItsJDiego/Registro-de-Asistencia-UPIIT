...
public class ViewUser extends javax.swing.JFrame {
    ...
    public ViewUser() {
        initComponents();
        BDUtility.setImage(this, "images/back.jpg", 1212, 544);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Observar usuario");
        ...
        userTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre", "Genero", "Correo", "Contacto", "Direccion", "Estado", "País", "Id de Registro", "Nombre Imagen"
            }
        ));
    ...
    private void userTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userTableMouseClicked
        ...
        if(!Objects.isNull(name)){
            ...
            if(imageFile.exists()){
                ...
                lblImage.setIcon(null);
                JOptionPane.showMessageDialog(null,"La imagen ha sido eliminada o no encontrada.","Imagen no encontrada",JOptionPane.WARNING_MESSAGE);
            }
        } else{
            lblImage.setIcon(null);
          }
